...
#'
#' `is_first_day_of_quarter()` and `is_last_day_of_quarter()` check wheter a
...
#' is_first_day_of_quarter(x)
#' is_last_day_of_quarter(x)
...
is_quarter_bounds <- function(
  ...
  is_first_day_of_quarter(first) &
  last_day_of_quarter(first) == last
}
...
is_first_day_of_quarter <- function(
  x
){
...
#' @export
#' @rdname is_quarter_bounds
is_last_day_of_quarter <- function(
  x
){
