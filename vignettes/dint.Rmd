...
p + scale_x_date(labels = format_date_yq_iso) + ggtitle("date_yq_iso")
p + scale_x_date(labels = format_date_ym_short) + ggtitle("date_ym_short")
p + scale_x_date(labels = format_date_ym_shorter) + ggtitle("date_ym_shorter")
